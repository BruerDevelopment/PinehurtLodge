...
export default function Splash() {
  ...
  return (
    <SplashWrap>
      {isMobile == false ? (
        <DesktopSplash>
          <img alt="Desktop Splash" src="/HousePhotos/exterior/exterior_in_snow.jpeg"/>
        </DesktopSplash>
      ): (
        <MobileSplash>
          <img alt="Mobile Splash" src="/HousePhotos/exterior/exterior_in_snow.jpeg"/>
        </MobileSplash>
      )}
      <Overlay>
        <div id="title">
          <h1>Pinehurst Lodge</h1>
          <h2>Cozy Ski Cabin</h2>
          <span>for the Powder Fanatics</span>
          <Link href="https://checkout.lodgify.com/pinehurst-lodge/846898/reservation?currency=USD">Book Your Next Stay Now!</Link>
        </div>
...
const DesktopSplash = styled.div`
  img {
    background-image: url("/HousePhotos/exterior/exterior_in_snow.jpeg");
    &::before {
      color: transparent;
    }
    object-fit: cover;

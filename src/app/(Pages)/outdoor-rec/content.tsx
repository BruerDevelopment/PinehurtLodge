  ...
  return (
    <>
      <Section style={{ "paddingTop": "0px" }}>
        <h1 className="heading">The Pinehurst Lodge, Your Luxury “Base-Camp”</h1>
        <SubTitle>This cozy getaway is ideal for hikers, fishermen, rafters, mountain bikers and rock climbers <br />or groups of friends and family.</SubTitle>
        <IntroArea>

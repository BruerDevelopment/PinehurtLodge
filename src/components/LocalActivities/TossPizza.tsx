...
export default () => {
    return (
        <>
            <TwoImages>
                <ExportedImage
                  src="/images/local_attractions/restaurants/toss_pizza/photo_0001.jpg"
                  alt="Toss Pizza Photo"
                  width={195}
                  height={156}
                  loading="lazy"
                />
                <ExportedImage
                  src="/images/local_attractions/restaurants/toss_pizza/photo_0003.png"
                  alt="Toss Pizza Photo"
                  width={195}
                  height={156}
                  loading="lazy"
              ...
              <CenterColumn>
                ...
                <Link href="https://www.tosswoodfired.com/" target="_blank">
                    View The Toss Website <BsBoxArrowUpRight />
                </Link>
              </CenterColumn>
        </>
    )
